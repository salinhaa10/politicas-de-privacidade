# Política de Privacidade - Conecta Vera Cruz

## Introdução
Nossa política de privacidade ajudará você a entender que informações coletamos no aplicativo **Conecta Vera Cruz**, como as utilizamos e quais são suas escolhas.

O **Conecta Vera Cruz** foi desenvolvido como um aplicativo gratuito. Este SERVIÇO é fornecido sem custo e é destinado ao uso conforme apresentado.

Ao escolher usar nosso Serviço, você concorda com a coleta e uso de informações em relação a esta política. As Informações Pessoais que coletamos são usadas para fornecer e melhorar o Serviço. Não compartilharemos suas informações com terceiros, exceto conforme descrito nesta Política de Privacidade.

## Coleta e Uso de Informações
Para melhor experiência ao usar nosso Serviço, podemos solicitar que você forneça certas informações de identificação pessoal, incluindo, mas não limitado a:
...
* Validar sua elegibilidade para o programa
* Melhorar a qualidade do serviço
* Análise de dados agregados

## Informações do Dispositivo
Coletamos informações do seu dispositivo em algumas situações. As informações serão utilizadas para:

* Melhorar a qualidade do serviço
* Prevenir atividades fraudulentas
* Garantir a segurança da plataforma

Essas informações não incluem dados que identifiquem individualmente o usuário.
...
* Executar serviços relacionados ao Serviço
* Nos ajudar a analisar como nosso Serviço é utilizado

Informamos aos usuários que esses terceiros têm acesso às suas Informações Pessoais. Eles estão obrigados a não divulgar ou utilizar as informações para qualquer outro propósito.
